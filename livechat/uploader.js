...
async function uploadToS3(dataBase64, contentType, bucketPath, newFileName, botConfig) {
...
async function uploadFile(dataBase64, contentType, bucketPath = '', newFileName) {
  ...
  if (success) {
    return `${botConfig.chatbot.cloud_storage_url.replace('{}', botConfig.chatbot.cloud_bucket)}/${newFileName}`;
  }
  return null;
...
// uploadFile(base64, mimeType, 'testing', 'yo.jpg');
